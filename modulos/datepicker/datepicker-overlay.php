...
echo str_replace("@","?","<@xml-stylesheet href='". $_BasePath ."modulos/datepicker/datepicker.css' type='text/css'@>");
...
<script type="application/x-javascript" src="<?php echo $_BasePath; ?>modulos/datepicker/dateUtils.js"/>
<script type="application/x-javascript" src="<?php echo $_BasePath; ?>modulos/datepicker/datepicker.js"/>
...
<vbox id="oe-date-picker-overlay-box" >
   ...
   <!-- Year controls -->
      <hbox id="oe-date-picker-year-controls-box"  >
         ...
         <box flex="1">   
            <image src="<?php echo $_BasePath; ?>modulos/datepicker/skin/arrow.gif" onclick="oeDatePicker.previousYearCommand()"/>
         </box>
