...
while ( $row = Row($res) ) {
	...
	$firma = "INSERT INTO ges_productos ( Referencia, CodigoBarras, CosteSinIVA, IdFamilia, IdSubFamilia, IdProvHab, IdMarca, IdTallaje, IdTalla, RefProvHab, IdColor, IdProdBase";
	$firma = "INSERT INTO ges_productos (";
//	$sqlcopia = str_replace("\n", "", $sqlcopia);
	$sqllimpio = str_replace("\n", "", $sqloriginal);
	$sqlcopia = str_replace($firma, "", $sqlcopia);
//	$sqlcopia = str_replace("IdNumeroZapato", "", $sqlcopia);
