...
<grid>
	...
	<rows>
		...
		<caption  class="media" id="abono_Debe" style="color: ref;font-weight: bold"  label="0 EUR"/>
		</row>
		<row>
		<description class="media">Abona:</description>
		<caption  class="media" id="abono_nuevo"  label="0 EUR"/>
		</row>	
		<row>
		<description  class="media">Nuevo pendiente:</description>
		<caption  class="media" id="abono_Pendiente"  label="0 EUR"/>
		</row>	
		...
		<box/>
		<hbox>
		<button  class="media" flex="1" image="img/colorprint30.png"  label="¿Abonar?" oncommand="RealizarAbono()"/>		
