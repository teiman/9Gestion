...
function ListadoTiendasPrecios($IdProducto,$copias) {
	...
	if ($numPreciosValidos==0) {
		//echo gas("Aviso",_("Precio es cero en todos los almacenes") . "<p>".
			
		//echo ;
		echo gas("Aviso",_("Aun no ha especificado un precio para este producto, por favor hagalo ahora para imprimir etiquetas")); 
?>
<center>
         <form action="selimpresion.php?modo=codigobarrasProducto2" method="post">
	<table class='forma'>
	<tr><td class="lh"><?php echo _("Precio:") ?></td><td><input value="0" type="text" name="precio"></td></tr>
	<tr><td class="lh"></td><td><input class="btn item" value="<?php echo _("Enviar") ?>" type=submit></td></tr>
	</table>
...
<?php		
	...
	$ot->fijar("cuerpo",$out);
	$ot->fijar("action",$action ."?modo=codigobarrasProducto2");
